...
def main():
    ...
    new_data = []
    for i, ann in enumerate(tqdm(data, colour='white', desc='EDIT Distance Calculation_f_A', dynamic_ncols=True)):
        # print(ann)
    ...
    with open(data_file.replace('preference_with_answer_A.json', 'preference_with_answer_A_precal.pkl'), 'wb') as file:
