...
def main():
    data_file = '/home/Tenemin/Project/CasCoD/dataset/bbh/bbh_all_data/step_4_after_final_check_all_task_train_preference_with_answer_B.json'
    model_name = "/home/Tenemin/Project/slm/hf/Llama-3.2-1B_B/std-lr=0.0002-wd=0.05-alpha=1train_data_name=all_task_train_right_wronghint_answer_B-bbh_llmst_dataset/load-from-epoch-15-std-lr=5e-06-rge2=1.01-wd=0-alpha=0.5-bbh_krsl_dataset/load-from-epoch-18-std-lr=5e-06-rge2=1.01-wd=0-alpha=0.5-bbh_krsl_dataset/load-from-epoch-2-std-lr=5e-06-rge2=1.01-wd=0-alpha=0.5-bbh_krsl_dataset/epoch-1"
    max_words = 1024
    ...
    new_data = []
    for i, ann in enumerate(tqdm(data, colour='white', desc='EDIT Distance Calculation_f_B', dynamic_ncols=True)):
        # print(ann)
    ...
    with open(data_file.replace('preference_with_answer_B.json', 'preference_with_answer_B_precal.pkl'), 'wb') as file:
