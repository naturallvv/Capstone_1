...
save_type="hf"
train_data_path="./dataset/bbh/bbh_all_data/all_task_train_right_wronghint_answer_A.json" # for the 1st step in edit
output_dir="../slm/$save_type/${last_dirname}_A"
mkdir -p "$output_dir"
ckpt_continue=None
max_words=1024
num_epochs=15
