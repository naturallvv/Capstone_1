...
krsl_train_data_path="/home/Tenemin/Project/CasCoD/dataset/bbh/bbh_all_data/step_4_after_final_check_all_task_train_preference_with_answer_B.json"
krsl_weight_path="/home/Tenemin/Project/CasCoD/dataset/bbh/bbh_all_data/step_4_after_final_check_all_task_train_preference_with_answer_B_precal.pkl"
forward_type='concat'
...
torchrun --nnodes 1 --nproc_per_node 4 --master-port 29829 ./finetuning.py \
    --max_words $max_words \
